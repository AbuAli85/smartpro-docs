-- ============================================================
-- EXPORT DATA FROM OLD SUPABASE PROJECT (FINAL VERSION)
-- ============================================================
-- Based on your table structure:
-- - services.company_id ✅ EXISTS (use this)
...
-- EXPORT SERVICES
-- ============================================================
-- Uses company_id (which exists) and maps it to provider_company_id
...
-- EXPORT BOOKINGS
-- ============================================================
-- provider_company_id and package_id both exist ✅
...
-- INSTRUCTIONS
-- ============================================================
-- 1. Run each SELECT statement above in your OLD Supabase project
-- 2. Copy the results (right-click → Copy or Export as CSV)
-- 3. Save to CSV files:
--    - profiles_export.csv
...
-- 5. Then import to NEW unified project using IMPORT_TO_NEW_PROJECT.sql
-- ============================================================
